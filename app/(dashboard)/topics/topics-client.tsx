    ...
    <div style={{ maxWidth: 900, margin: "0 auto" }}>
      ...
      <div
        ...
        style={{
          padding: "22px 24px",
          marginBottom: 20,
          background: "linear-gradient(135deg, color-mix(in srgb, var(--accent) 8%, var(--bg-card)) 0%, var(--bg-card) 100%)",
          borderColor: "var(--ring-accent)",
        }}
      >
        ...
        {suggestError && (
          <div style={{
            marginTop: 16,
            background: "var(--danger-dim)", border: "1px solid var(--ring-danger)",
                ...
                return (
                  <div
                    ...
                    style={{
                      ...
                      border: `1px solid ${added ? "var(--ring-success)" : "var(--border)"}`,
                      borderRadius: 10,
                      padding: "14px 16px",
                      transition: "all 0.2s",
                    }}
